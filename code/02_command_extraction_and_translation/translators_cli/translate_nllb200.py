...
def translate(texts: list[str], model, tokenizer, device,
              ...
              tgt_lang: str = "ita_Latn") -> list[str]:
...
def main():
    parser = argparse.ArgumentParser(
        description="Translate commands using facebook/nllb-200-3.3B"
    )
    ...
    parser.add_argument("--model-name",
                        ...
                        help="Model name or path (default: facebook/nllb-200-3.3B)")
    parser.add_argument("--src-lang", default="eng_Latn",
                        help="Source language code (default: eng_Latn)")
    parser.add_argument("--tgt-lang", default="ita_Latn",
                        help="Target language code (default: ita_Latn)")
